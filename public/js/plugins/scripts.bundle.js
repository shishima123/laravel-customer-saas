...
var KTPortlet = function(elementId, options) {
    ...
    var defaultOptions = {
        ...
        tools: {
            toggle: {
                collapse: typeof window.locale == 'undefined' ? 'Collapse' : trans('message.collapse'),
                expand: typeof window.locale == 'undefined' ? 'Expand' : trans('message.expand')
            },
            reload: typeof window.locale == 'undefined' ? 'Reload' : trans('message.reload'),
            remove: typeof window.locale == 'undefined' ? 'Remove' : trans('message.remove'),
            fullscreen: {
                on: 'Fullscreen',
                off: 'Exit Fullscreen'
            }
